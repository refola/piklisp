...
# Calling the class macro in Pyylisp should look a lot like defining a
...
# variable, you can use the magic Pyylisp --init-- instead of
# __init__.
...
# Pyylisp. The dots are not syntax, but rather part of the symbols
